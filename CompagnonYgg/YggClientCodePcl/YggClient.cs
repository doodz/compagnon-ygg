...
using YggClientCodePcl.Search;
using YggClientCodePcl.YggHtml;

namespace YggClientCodePcl
{
    public class YggClient
    {
        ...
        public async Task PostLogin(string id, string pass)
        {
            ...
            using (var client = new HttpClient(_httpClientHandler))
            {
                ...
                {
                    new KeyValuePair<string, string>(nameof(id), id),
                    new KeyValuePair<string, string>(nameof(pass), pass),
