...
using System.Linq;
using YggClientCodePcl.User;

namespace YggClientCodePcl.YggHtml
{
    public class YggHtmlParser
    {
        ...
        public static bool GetFreeleech(HtmlDocument doc)
        {
            return doc.DocumentNode.InnerText.IndexOf("freeleech", StringComparison.OrdinalIgnoreCase) > 0;
            //return doc.DocumentNode.InnerText.Contains("Freeleech");
